...
public class CH_QLDDD extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(250, 250, 242));

        jPanel16.setBackground(new java.awt.Color(14, 116, 188));
        ...
        jLabel30.setText("Phần mềm quản lí ");

        jLabel29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/trangchu.jpg"))); // NOI18N
        jLabel29.setVerticalAlignment(javax.swing.SwingConstants.TOP);

        jLabel31.setFont(new java.awt.Font("Segoe UI", 3, 36)); // NOI18N
        jLabel31.setText("Cửa hàng đồ gia dụng");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã sản phẩm", "Tên sản phẩm", "Giá bán", "Số lượng", "Mã loại","Link ảnh" }));
...
//        jComboBox16.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        B_DH = new BUSINESSLOGIC.B_DonHang(this);
...
//tab khachhang
    ...
    private BUSINESSLOGIC.B_DonHang B_DH;   
    ...
    private void jTable2MouseClicked(MouseEvent evt) {
     ...
     private void jTable3MouseClicked(MouseEvent evt) {
        if (this.jTable3.getSelectedRow() >= 0) {
            String madh = this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 0).toString();
            jTextField14.setText(madh);
            String tt = this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 1).toString();
            jComboBox3.setSelectedItem(tt);
            Date ndh = (Date) this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 2);
            jDateChooser1.setDate(ndh);
            Date ngh = (Date) this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 3);
            jDateChooser2.setDate(ngh);
            
             String gia = this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 5).toString();
            jTextField5.setText(gia);
            
            String makh = this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 6).toString();
            jTextField15.setText(makh);
            
            String msp = this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 7).toString();
            jTextField31.setText(msp);
            int sl =  (int) this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 4);
            jSpinner1.setValue(sl);
...
// TAB  SAN PHAM
        ...
        if (e.getSource() == this.jButton9) {
            int k = this.B_DH.InsertDH();
            this.B_DH.LoadDonHang();
        } else if (e.getSource() == this.jButton10) {
            int k = this.B_DH.UpdateDH();
            this.B_DH.LoadDonHang();
        } else if (e.getSource() == this.jButton11) {
            int k = this.B_DH.DeleteDH();
            this.B_DH.LoadDonHang();
        }

            if (e.getSource() == jTextField16) {
            String tsSP = jTextField16.getText();
            if (tsSP.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Vui lòng nhập trước khi tìm kiếm!");
            }
           searchInTable(jTable3, tsSP);

        }
        
        if (e.getSource() == jComboBox4) {           
            String selectedColumn = (String) jComboBox4.getSelectedItem();
                sortTableByColumn(jTable3,selectedColumn);
